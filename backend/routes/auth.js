...
// const JWT_SECRET = 'Ritik@isaboy'

// //ROUTE 1.
// //Create a User using:POST "/api/auth/createuser". No login required
// router.post('/createuser', [
//   body('name', 'valid name is required').isLength({ min: 3 }),
//   body('email', 'valid email is required').isEmail(),
//   body('password', 'valid password is required').isLength({ min: 5 })
...
//   //Taking out email and password from User
...
//     //Cpmparing the password with(bcrypt)
